...
public class MyHtmlHandler1 implements HttpHandler{
	...
	public void handle(HttpExchange t) throws IOException{
        ...
        String response = "";
        response = "<html lang=\"en\"><head><meta charset=\"UTF-8\"><title>Library</title></head><body><center><h1>Select the genre you are interested in:</h1><form method=\"GET\" action=\"DisplayBooks\"><br><input type=\"radio\" name=\"gender\" value=\"fantasy\" checked>FANTASY<br><input type=\"radio\" name=\"gender\" value=\"mystery\">MYSTERY<br><input type=\"radio\" name=\"gender\" value=\"fiction\">FICTION<br><br><input type=\"submit\"></form><br><p><a href=\"http://localhost:8001/\">Home</a></p></center></body></html>";
